// az deployment sub create --template-file .\test.bicep -l 'Southeast Asia'
...
@maxLength(90)
param resourceGroupName string = 'dep-hangxutest7-kc-flux-rg'
...
module flux 'flux.bicep' = {
  scope: resourceGroup
  name: 'fluxextension'
  params: {
    clusterName: clusterName
    clusterExtensionName: 'flux'
  }
}
