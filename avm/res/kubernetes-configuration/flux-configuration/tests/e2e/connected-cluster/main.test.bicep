// az deployment sub create --template-file .\main.test.bicep -l 'Southeast Asia'
...
@maxLength(90)
param resourceGroupName string = 'dep-${namePrefix}-kc-${serviceShort}-rg'
...
param namePrefix string = 'hangxutest8'
