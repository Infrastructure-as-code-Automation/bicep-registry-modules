...
// Non-required parameters
param cloudInitDataSource = 'NoCloud'
...
| [`identifier`](#parameter-identifier) | object | The image identifier. |
| [`name`](#parameter-name) | string | Name of the resource to create. |
| [`osType`](#parameter-ostype) | string | The OS type. |
| [`version`](#parameter-version) | object | The version information. |

**Optional parameters**

| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`cloudInitDataSource`](#parameter-cloudinitdatasource) | string | The cloud init data source. |
| [`containerId`](#parameter-containerid) | string | The container ID. |
| [`enableTelemetry`](#parameter-enabletelemetry) | bool | Enable/Disable usage telemetry for module. |
| [`hyperVGeneration`](#parameter-hypervgeneration) | string | The Hyper-V generation. |
...
| :-- | :-- | :-- |
| `hyperVGeneration` | string | The Hyper-V generation of the marketplace gallery image. |
| `location` | string | The location of the marketplace gallery image. |
| `name` | string | The name of the marketplace gallery image. |
| `osType` | string | The OS type of the marketplace gallery image. |
